  ...
  return (
    <section className="grid gap-4 lg:grid-cols-[1fr_1fr]">
      <div className="rounded-3xl border border-line/70 bg-panel/70 p-5">
        <p className="text-xs uppercase tracking-[0.24em] text-muted">Scoring Panel</p>
        ...
        <div className="mt-4 flex flex-wrap items-end gap-3">
          <label className="flex flex-col gap-2 text-sm text-muted">
            ...
            <select
              ...
              className="min-w-72 rounded-2xl border border-line bg-background px-3 py-3 font-mono text-sm text-foreground"
            >
              {sampleRows.map((row) => (
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-2xl bg-green px-4 py-3 font-semibold text-background transition hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-50"
          >
            <Zap size={16} />
      ...
      <div className="rounded-3xl border border-dashed border-cyan/35 bg-cyan/5 p-5">
        <p className="text-xs uppercase tracking-[0.24em] text-cyan">CSV Upload</p>
        ...
        <div className="mt-4 flex items-center gap-3">
          ...
          <button
            ...
            disabled={scoring}
            className="inline-flex items-center gap-2 rounded-2xl border border-cyan/40 px-4 py-3 font-semibold text-cyan transition hover:bg-cyan/10 disabled:cursor-not-allowed disabled:opacity-50"
          >
            <UploadCloud size={16} />
            Upload CSV
          </button>
